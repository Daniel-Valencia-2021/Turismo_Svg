...
<link rel="stylesheet" href="{{ asset('static/css/bootstrap-datepicker.css')}}">
<link rel="stylesheet" href="{{ asset('static/css/jquery.timepicker.css')}}">
